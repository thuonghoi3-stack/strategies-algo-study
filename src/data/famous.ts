...
export const FAMOUS_ALGORITHMS: Algorithm[] = [
  {
    slug: "weinstein-s2",
    ...
    summary:
      "Secrets for Profiting in Bull and Bear Markets. Bốn pha: 1 basing, 2 advancing, 3 topping, 4 declining. Edge nằm ở Stage 2 — giá trên MA dốc lên, volume xác nhận. Thoát khi mất Stage 2 (vào 3 hoặc 4). Không phải indicator; là bản đồ chu kỳ.",
    how: [
    ...
    params: [
      { key: "ma", label: "SMA n", min: 15, max: 80, step: 1, default: 30 },
      { key: "slope", label: "Slope lookback", min: 3, max: 15, step: 1, default: 5 },
    ],
    best: "uptrend",
    tags: ["Weinstein", "stage", "weekly"],
  },
  {
    slug: "tp-mr",
    name: "TP + MR",
    ...
    summary:
      "Tổ hợp desk phổ biến. Khi EMA nhanh trên EMA chậm — mua pullback reclaim EMA (trend pullback). Khi hai EMA sát nhau — thị trường không persist, fade dải Bollinger với RSI cực. Sai regime là chết: fade BB trong Stage 2, hoặc đuổi EMA trong range.",
    how: [
    ...
    params: [
      { key: "fast", label: "EMA nhanh", min: 8, max: 21, step: 1, default: 21 },
      { key: "slow", label: "EMA chậm", min: 34, max: 89, step: 1, default: 55 },
      { key: "bb", label: "BB n", min: 14, max: 30, step: 1, default: 20 },
      { key: "rsi", label: "RSI n", min: 7, max: 21, step: 1, default: 14 },
    ],
    best: "mixed",
    tags: ["hybrid", "pullback", "fade"],
  },
  {
    slug: "macd-strategy",
    name: "MACD Strategy",
    ...
    summary:
      "Appel dùng như hệ: vào khi MACD cắt signal và hist đã dương (long). Zero-line cross là đổi bias, không phải entry. Thoát khi cross ngược hoặc hist co 2 nến. 12/26/9 là convention; H1 hay dùng 8/21/5.",
    how: [
  ...
  },
  {
    ...
    summary:
      "Wilder gốc. Trong range, thoát 30/70 có edge. Trong trend, RSI neo 70 rất lâu — short đó là tự sát. Hệ này chỉ tín hiệu khi RSI cắt ra khỏi vùng cực, không khi mới vào.",
    how: [
    ...
    params: [
      { key: "period", label: "RSI n", min: 5, max: 21, step: 1, default: 14 },
      { key: "ob", label: "Overbought", min: 60, max: 85, step: 1, default: 70 },
      { key: "os", label: "Oversold", min: 15, max: 40, step: 1, default: 30 },
    ],
    best: "range",
    tags: ["Wilder", "30/70"],
  },
  {
    ...
    summary:
      "John Bollinger không bảo fade mọi touch. Hệ này thêm RSI: chỉ fade khi dải và momentum cùng nói 'đi quá'. Squeeze không phải setup của hệ này — xem TTM Squeeze.",
    how: [
      "Chạm dải + RSI < 35 / > 65.",
    ...
    params: [
      ...
      { key: "k", label: "σ", min: 1.5, max: 3, step: 0.1, default: 2 },
    ],
    best: "range",
    tags: ["Bollinger", "fade"],
  },
  {
    ...
    summary:
      "Full stochastic. Chỉ nhận cross dưới 25 (long) hoặc trên 75 (short). Failure swing — %K không làm cực mới khi giá có — là bản nâng cao, hệ này lấy cross thuần.",
    how: [
  ...
  },
  {
    ...
    summary:
      "12/26 là MACD không histogram. Sống ở trend, chết ở range. Đừng thêm filter rồi gọi là 'cải tiến' nếu bạn không đo. Ribbon 8/21/55 ít nhiễu hơn cặp hai đường.",
    how: [
    ...
    params: [
      { key: "fast", label: "Nhanh", min: 5, max: 20, step: 1, default: 12 },
      { key: "slow", label: "Chậm", min: 18, max: 50, step: 1, default: 26 },
    ],
    best: "uptrend",
    tags: ["crossover", "EMA"],
  },
  {
    ...
    summary:
      "Rule 4-week (sau này 20 ngày). Đóng cửa làm high N → long; làm low N → short. Không đoán, không filter. Turtle S1 thêm cửa sổ thoát ngắn hơn entry; S2 kéo N lên 55. Hệ này là bản kênh thuần — entry = exit = N.",
    how: [
    ...
    params: [
      { key: "entry", label: "Entry n", min: 10, max: 55, step: 1, default: 20 },
      { key: "exit", label: "Exit n", min: 5, max: 40, step: 1, default: 20 },
    ],
    best: "breakout",
  ...
  },
  {
    ...
    summary:
      "9/21 phổ biến hơn 12/26 trên khung nhỏ. Pullback vào EMA 9 trong khi 9 còn trên 21 thường tốt hơn đuổi cross. Time-stop 8–12 nến.",
    how: [
    ...
    params: [
      { key: "fast", label: "Nhanh", min: 5, max: 13, step: 1, default: 9 },
      { key: "slow", label: "Chậm", min: 15, max: 34, step: 1, default: 21 },
    ],
    best: "uptrend",
    tags: ["scalp", "9/21"],
  },
  {
    ...
    summary:
      "Original Turtle System 1. Vào khi giá làm đỉnh/đáy 20 ngày, thoát khi ngược 10 ngày. Thua nhiều, thắng lớn. Không skip breakout vì 'trông đắt'. Position size = 1% / ATR — phần bị bỏ quên nhiều nhất.",
    how: [
    ...
    params: [
      { key: "entry", label: "Entry n", min: 10, max: 40, step: 1, default: 20 },
      { key: "exit", label: "Exit n", min: 5, max: 20, step: 1, default: 10 },
    ],
    best: "breakout",
    tags: ["Turtle", "Donchian", "S1"],
  },
  {
    slug: "turtle-s2",
    ...
    summary:
      "System 2 bắt sóng mà S1 bỏ vì skip-rule, và bắt trend chậm hơn nhưng sạch hơn. 55 ngày là 'đỉnh không ai còn nhớ' — đúng nghĩa breakout.",
    how: [
    ...
    params: [
      { key: "entry", label: "Entry n", min: 40, max: 80, step: 1, default: 55 },
      { key: "exit", label: "Exit n", min: 10, max: 30, step: 1, default: 20 },
    ],
    best: "breakout",
    tags: ["Turtle", "S2"],
  },
  {
    ...
    summary:
      "S2 thuần short cả uptrend. Thêm EMA 200 (ở đây n chỉnh được vì chuỗi giả lập ngắn) — long chỉ khi giá trên MA, short chỉ khi dưới. Giảm whipsaw hai phía, bỏ sóng ngược MA.",
    how: [
      "Break Donchian 55.",
      "Cùng phía EMA n.",
    ...
    params: [
      { key: "don", label: "Donchian", min: 20, max: 80, step: 1, default: 55 },
      { key: "ma", label: "EMA n", min: 40, max: 200, step: 5, default: 80 },
    ],
    best: "uptrend",
    tags: ["Turtle", "filter"],
  },
  {
    ...
    summary:
      "Keltner dùng ATR nên kênh không giật theo outlier như σ Bollinger. Close ngoài kênh = momentum. Wick ngoài rồi đóng trong = rejection, không phải break.",
    how: [
    ...
    params: [
      ...
      { key: "mult", label: "Hệ số", min: 1, max: 3, step: 0.1, default: 1.5 },
    ],
    best: "breakout",
    tags: ["Keltner", "ATR"],
  },
  {
    ...
    summary:
      "Short Term Trading Strategies That Work. Mean-reversion trong uptrend: chỉ long khi C > SMA200 và RSI(2) cực thấp. Càng thấp càng tốt (<5 hơn <10). Exit khi giá cắt lên SMA5 hoặc RSI(2) > 70. Không phải RSI 14.",
    how: [
    ...
    params: [
      { key: "rsi", label: "RSI n", min: 2, max: 5, step: 1, default: 2 },
      { key: "ma", label: "SMA filter", min: 30, max: 120, step: 5, default: 50 },
      { key: "th", label: "Ngưỡng RSI", min: 2, max: 15, step: 1, default: 10 },
    ],
    best: "uptrend",
    tags: ["Connors", "RSI-2"],
  },
  {
    ...
    summary:
      "Connors: một ngày RSI(2)<10 có thể là nhiễu. Tổng 2 ngày < 10–20 = bán kéo dài, mean-reversion đáng tin hơn. Cùng filter SMA. Exit RSI(2) cắt 70.",
    how: [
    ...
    params: [
      { key: "rsi", label: "RSI n", min: 2, max: 5, step: 1, default: 2 },
      { key: "sum", label: "Số ngày cộng", min: 2, max: 4, step: 1, default: 2 },
      { key: "ma", label: "SMA filter", min: 30, max: 120, step: 5, default: 50 },
      { key: "th", label: "Ngưỡng CRSI", min: 8, max: 40, step: 1, default: 20 },
    ],
    best: "uptrend",
    tags: ["Connors", "CRSI"],
  },
  {
    ...
    summary:
      "Volatility compression. BB(20,2) trong KC(20,1.5) = dots đỏ (squeeze on). Khi BB cắt ra, dots xanh, histogram momentum cho chiều. Không đoán squeeze sẽ nổ lên hay xuống — chờ fire.",
    how: [
    ...
    params: [
      { key: "period", label: "Chu kỳ", min: 12, max: 30, step: 1, default: 20 },
      { key: "bbk", label: "BB σ", min: 1.5, max: 2.5, step: 0.1, default: 2 },
      { key: "kcm", label: "KC m", min: 1, max: 2, step: 0.1, default: 1.5 },
    ],
    best: "breakout",
    tags: ["Carter", "squeeze"],
  },
  {
    ...
    summary:
      "Desk quant đơn giản. Giá không đi quá xa VWAP phiên nếu không có tin. Z-score chuẩn hóa khoảng cách theo vol trong phiên. Fade z > 2, cover về 0–1. Không fade nếu VWAP đang dốc đứng (trend phiên).",
    how: [
    ...
    params: [
      { key: "reset", label: "Reset phiên", min: 16, max: 80, step: 2, default: 40 },
      { key: "win", label: "σ window", min: 8, max: 30, step: 1, default: 16 },
      { key: "z", label: "|Z| ngưỡng", min: 1.2, max: 3, step: 0.1, default: 2 },
    ],
    best: "range",
    tags: ["VWAP", "z-score"],
  },
  {
    ...
    summary:
      "Intraday continuation. Không fade VWAP, không break lần đầu. Chờ giá xuyên rồi reclaim: nến đóng lại trên VWAP sau khi đã dip. Đó là 'failed breakdown' của phiên.",
    how: [
    ...
    params: [{ key: "reset", label: "Reset", min: 16, max: 80, step: 2, default: 40 }],
    best: "mixed",
    tags: ["VWAP", "reclaim"],
  },
  {
    ...
    summary:
      "StochRSI = Stoch(RSI(n)). Về 0/100 thường xuyên hơn RSI. Dùng như trigger trong trend (thoát 20 trong uptrend), không phải hệ độc lập. Cross %K/%D ở cực.",
    how: [
    ...
    params: [
      { key: "rsi", label: "RSI n", min: 7, max: 21, step: 1, default: 14 },
      { key: "k", label: "Stoch n", min: 8, max: 21, step: 1, default: 14 },
      { key: "d", label: "%D", min: 2, max: 5, step: 1, default: 3 },
    ],
    best: "range",
  ...
  },
  {
    ...
    summary:
      "Opening Range Breakout. 30–60 phút đầu (ở đây N nến đầu mỗi 'phiên' giả lập) tạo high/low. Break rồi hold. Failed break (xuyên rồi đóng lại trong) là fade. ATR của range nói ngày có 'đi'.",
    how: [
    ...
    params: [
      { key: "session", label: "Độ dài phiên", min: 20, max: 80, step: 5, default: 40 },
      { key: "orb", label: "Nến OR", min: 3, max: 12, step: 1, default: 5 },
    ],
    best: "breakout",
    tags: ["Crabel", "ORB"],
  },
  {
    ...
    summary:
      "RSI-7 nhạy. Dùng như impulse: cắt lên 50 = buyer kiểm soát ngắn hạn. Ngược với RSI Strategy (fade cực). Time-stop ngắn. Phù hợp burst, không phải swing tuần.",
    how: [
    ...
    params: [{ key: "period", label: "RSI n", min: 5, max: 10, step: 1, default: 7 }],
    best: "uptrend",
    tags: ["momentum", "RSI-7"],
  },
  {
    ...
    summary:
      "TSMOM khác cross-sectional momentum (xếp hạng asset). Chỉ hỏi: asset này tự nó đang lên hay xuống? Sign của total return N nến. Trend-following academically cleanest. Horizon gốc 1–12 tháng; lab dùng cửa sổ ngắn hơn.",
    how: [
    ...
    params: [{ key: "lb", label: "Lookback", min: 20, max: 120, step: 5, default: 60 }],
    best: "uptrend",
    tags: ["AQR", "TSMOM"],
  },
  {
    ...
    summary:
      "The 52-Week High and Momentum Investing. Trader neo neo đỉnh năm — break đỉnh đó là sự kiện. Hệ: long khi close > max(high, N), N≈252 daily (lab: 80–160). Không phải bắt đáy.",
    how: [
    ...
    params: [{ key: "lb", label: "Lookback", min: 40, max: 200, step: 5, default: 80 }],
    best: "breakout",
    tags: ["52w", "breakout"],
  },
  {
    ...
    summary:
      "Hai mặt. Gravity: khi dist% quá lớn, mean-revert về MA. Magnet: trong trend, lần chạm MA200 là entry theo chiều. Lab vẽ dải ± band quanh SMA n (n mặc định 80 vì chuỗi ngắn; daily thật dùng 200).",
    how: [
    ...
    params: [
      { key: "ma", label: "SMA n", min: 40, max: 200, step: 5, default: 80 },
      { key: "band", label: "Band", min: 0.03, max: 0.15, step: 0.01, default: 0.06 },
    ],
    best: "mixed",
    tags: ["SMA200", "mean"],
  },
  {
    ...
    summary:
      "Ariel, Lakonishok, Smidt. Luồng tiền quỹ/lương. Cửa sổ: ngày −1..+3. Hệ lab: bật long khi vào cửa sổ nếu giá trên SMA; đóng khi hết cửa sổ. Không phải Holy Grail — edge nhỏ, cần size lớn / chi phí thấp.",
    how: [
    ...
    params: [{ key: "ma", label: "SMA filter", min: 20, max: 80, step: 5, default: 40 }],
    best: "mixed",
  ...
  },
  {
    ...
    summary:
      "Scalp intraday phổ biến: EMA 9, VWAP phiên, EMA 21. Bias khi 9 > 21 và giá trên VWAP. Entry khi giá dip vào EMA 9 rồi đóng cửa trở lại trên — không đuổi nến đầu tiên xuyên cả ba. Short đối xứng. Time-stop ngắn.",
    how: [
    ...
    params: [
      { key: "fast", label: "EMA nhanh", min: 5, max: 13, step: 1, default: 9 },
      { key: "slow", label: "EMA chậm", min: 15, max: 34, step: 1, default: 21 },
      { key: "reset", label: "VWAP reset", min: 16, max: 80, step: 2, default: 40 },
    ],
    best: "uptrend",
    tags: ["scalp", "VWAP", "EMA"],
  },
  {
    ...
    summary:
      "Street Smarts. Turtle Soup: sau high 20 ngày, nếu giá không follow-through và đóng cửa trở lại dưới đỉnh cũ trong ~4 nến — short failed breakout. Turtle Soup Plus One chờ thêm nến. Đây là fade, không phải trend-follow.",
    how: [
    ...
    params: [
      { key: "don", label: "Donchian", min: 10, max: 30, step: 1, default: 20 },
      { key: "fail", label: "Cửa sổ fail", min: 2, max: 8, step: 1, default: 4 },
    ],
    best: "range",
    tags: ["Raschke", "fade"],
  },
  {
    ...
    summary:
      "Confluence đơn giản nhất của mean-reversion. Một mình BB hoặc RSI dễ giả. Cả hai cùng cực tăng xác suất về mid. Exit mid hoặc RSI 50. Stop ngoài swing, không trung bình giá.",
    how: [
    ...
    params: [
      { key: "rsi", label: "RSI n", min: 5, max: 21, step: 1, default: 14 },
      { key: "bb", label: "BB n", min: 14, max: 30, step: 1, default: 20 },
      { key: "k", label: "σ", min: 1.5, max: 3, step: 0.1, default: 2 },
      { key: "os", label: "RSI OS", min: 15, max: 35, step: 1, default: 30 },
    ],
    best: "range",
...
export const FAMOUS_STRATEGIES: Strategy[] = [
  {
    slug: "weinstein",
    name: "Weinstein Stage 2",
    kicker: "Chu kỳ 4 pha",
    blurb:
      "Chỉ giải ngân Stage 2: giá trên SMA 30 tuần dốc lên. Đứng ngoài Stage 1, bán Stage 3, short Stage 4. Bản đồ trước indicator.",
    ...
    stack: ["weinstein-s2", "donchian-ema200", "adx", "atr"],
  ...
  },
  {
    ...
    kicker: "Hai mode",
    blurb:
      "Trend pullback khi EMA xòe, mean-reversion BB/RSI khi EMA thắt. Một desk, hai playbook — trọng tài là khoảng cách EMA.",
    ...
    stack: ["tp-mr", "ema-ribbon", "bollinger", "rsi-strategy", "hurst"],
  ...
  },
  {
    ...
    kicker: "Breakout gốc",
    blurb:
      "S1 20/10 bắt sóng ngắn, S2 55/20 bắt sóng dài. Size = 1% / ATR. Thua thường, thắng ít nhưng lớn.",
    ...
    stack: ["turtle-s1", "turtle-s2", "donchian-turtle", "atr"],
  ...
  },
  {
    ...
    blurb:
      "SMA200 filter + RSI(2) hoặc Cumulative RSI. Mean-reversion 2–5 ngày, win rate cao, payoff nhỏ. Stop vẫn bắt buộc.",
    ...
    stack: ["connors-rsi2", "connors-crsi", "ma200-gravity", "rsi-bb-fade"],
  ...
  },
  {
    ...
    kicker: "Nổ sau nén",
    blurb:
      "Chờ BB ⊂ KC. Không đoán hướng. Fire + mom histogram. Trail Supertrend. Khác squeeze-break (Donchian) ở chỗ mom là trọng tài chiều.",
    ...
    stack: ["ttm-squeeze", "keltner-break", "bollinger", "supertrend"],
  ...
  },
  {
    ...
    blurb:
      "Hai play: fade |Z|>2 khi phiên đi ngang; reclaim VWAP khi phiên có drift. Đừng dùng cả hai cùng lúc.",
    ...
    stack: ["vwap-zscore", "vwap-reclaim", "orb", "e0v1e"],
  ...
  },
  {
    ...
    kicker: "EMA · VWAP · EMA",
    blurb:
      "9/VWAP/21. Bias cả ba cùng chiều, entry reclaim EMA 9, time-stop. Scalp chứ không swing.",
    ...
    stack: ["e0v1e", "ema-scalper", "vwap", "orb"],
  ...
  },
  {
    ...
    blurb:
      "Raschke: 20-day high không follow-through trong 4 nến → short. Ngược hẳn S1. Chỉ bật khi Hurst thấp.",
    ...
    stack: ["turtle-soup", "donchian", "hurst", "rsi-bb-fade"],
  ...
  },
  {
    ...
    blurb:
      "Turn-of-month + time-series momentum + 52-week high. Edge nhỏ, ổn định, cần chi phí thấp và size kỷ luật.",
    ...
    stack: ["turn-of-month", "tsm", "week52-high", "ma200-gravity"],
